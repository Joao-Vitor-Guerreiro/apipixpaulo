...
export class scalarController {
  static async create(req: Request, res: Response) {
    ...
    if (provider === "ghost") {
      ...
      apiUrl = "https://app.pluggou.io/api/payments/transactions";
      headers = {
        "Content-Type": "application/json",
      ...
      paymentData = {
        ...
        customerDocument: data.customer.document.number,
        customerDocumentType: "cpf",
        organizationId: organizationId,

        postbackUrl:
          "https://origem-api-pix.28ugko.easypanel.host/webhook-scalar",
      };
    }
